...
const difficultyMenuGroup: ExpandableMenuGroup = {
  ...
  items: [
    ...
    { path: "/admin/students", label: "审核与上报", mark: "审" },
    { path: "/admin/difficulty/database", label: "困难生数据库", mark: "库" },
    { path: "/admin/difficulty/guide", label: "业务手册", mark: "手" },
  ],
};

const grantMenuGroup: ExpandableMenuGroup = {
  title: "国家助学金",
  icon: "助",
  items: [
    { path: "/admin/grant", label: "助学金业务首页", mark: "助" },
    { path: "/admin/grant/database", label: "助学金数据库", mark: "据" },
  ],
};
