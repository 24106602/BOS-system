...
const studentColumns = [
  { key: "name", label: "姓名", aliases: ["name", "姓名", "学生姓名"] },
  { key: "studentId", label: "学号", aliases: ["student_id", "学号", "学生学号"] },
  { key: "idCard", label: "身份证号", aliases: ["id_card", "身份证号", "身份证件号"] },
  { key: "college", label: "学院", aliases: ["college", "学院", "院系"] },
  { key: "grade", label: "年级", aliases: ["grade", "年级", "所在年级"] },
  { key: "gender", label: "性别", aliases: ["gender", "性别"] },
  { key: "major", label: "专业", aliases: ["major", "专业", "专业名称"] },
  { key: "className", label: "班级", aliases: ["class_name", "班级", "行政班"] },
  { key: "difficultyLevel", label: "困难等级", aliases: ["difficulty_level", "困难等级", "困难认定等级"] },
  { key: "specialType", label: "特殊困难类型", aliases: ["special_type", "特殊困难类型", "特殊类型"] },
];
  ...
  const allRows = useMemo(() => {
    return studentBatches.flatMap((batch) =>
      batch.rows.map((row) => ({
        ...row,
        _batch: batch,
        _name: getText(row, ["name", "姓名"]),
        _studentId: getText(row, ["student_id", "学号"]),
        _idCard: getText(row, ["id_card", "身份证号"]),
        _college: getText(row, ["college", "学院"]) || batch.collegeName,
      }))
    );
  }, [studentBatches]);
